class state():
    '''
    класс отвечающий за игровой прогресс, описывает движения фигур, их
    положение как начальное так и внутриигровое, содержит две функции,
    первая построение доски, вторая движения фигур
    '''
